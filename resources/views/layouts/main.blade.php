    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">MyHalqah Admin<sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('mohallas.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Mohalla</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('halqahs.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Halqah</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('markazs.index') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Markaz</span></a>
            </li>
